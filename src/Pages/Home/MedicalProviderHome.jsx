  ...
  return (
    ...
    <Container>
        <Row className=" py-md-3 py-0">
           ...
           <button className=" border-0  rounded-5  singupbtnbgimg  py-2 ps-4 text-light  shadow ">Sign Up</button>
    ...
    <Container>
        ...
        <Col  md={6}
          ...
          <button className=" border-0  rounded-5  singupbtnbgimg mt-3  py-2 ps-4 text-light  shadow ">Sign Up</button>
            </Col>
        </Row>
    </Container>
    </div>

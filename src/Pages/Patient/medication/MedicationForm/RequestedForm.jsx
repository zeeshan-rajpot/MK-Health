  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.promise(
        ...
        {
          pending: "Adding prescription...", // Pending message
          success: "Prescription added successfully!", // Success message
    ...
    <>
              ...
              <div className=" mobw90 m-auto  mt-4" style={{ width: "80%" }}>
                ...
                <div className="w-100 my-4">
                  <textarea
                     ...
                     value={formData.reson || ''} // Set the value from formData if it exists
      ...
      <Modal show={showModal} onHide={handleClose} size="lg">
        <Modal.Body className="p-0 rounded-3 ">
          <ConfirmRequestModal data={formData} responseData={responseData} />
        </Modal.Body>
      </Modal>

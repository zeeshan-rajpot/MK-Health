        ...
        <Row>
          <Col>
            ...
            >
              ...
              <img src={ "/Search.svg"} />
              <input type="text" name='email'  placeholder="Texas" className="bg-light" />
            </div>
                </div>
...
'  style={{height:'90px'}}></textarea>
            ...
            >
              <h6 className="ms-2 ms-md-5  pb-1">
                <b style={{ color: "#FAB915" }}>Step 2 - Prescription Request</b>
              </h6>
              ...
              <div className="w-100" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Medication Name(s) (if known)'  style={{height:'90px'}}>
                   </textarea>
               </div>
              ...
              <div className="w-100 my-4" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Desired Quantity (if known)'  style={{height:'90px'}}>
                   </textarea>
               </div>
          ...
          <div className=" mobw90 m-auto " style={{width:'80%'}}>
            ...
            <p className="" style={{color:'#747E93' ,fontSize:'13px'}}>Please enter your current vital signs if you have them. This will help your medical provider
assess your current needs.</p>


    
<div className="w-100 my-4" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Temperature (e.g. 98° Fahrenheit)'  style={{height:'90px'}}>
                   </textarea>
               </div>
                   
          <div className="w-100 my-4" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Heart Rate (e.g. 76 beats per minute)'  style={{height:'90px'}}>
                   </textarea>
               </div>
          
              
               <div className="w-100 my-4" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Blood Pressure (e.g. 125 / 75)'  style={{height:'90px'}}>
                   </textarea>
               </div>
          
              
               <div className="w-100 my-4" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Weight (e.g. 155 lbs)'  style={{height:'90px'}}>
                   </textarea>
               </div>
               <div className="w-100 my-4" >
                  <textarea name="" id="" className="w-100 border-0 shadow  rounded-4 p-3" placeholder='Height (e.g. 72 inches)'  style={{height:'90px'}}>
                   </textarea>
               </div>

...
export const Contactdetail = ({ updateData }) => {
  const CreateAccount = [
    ...
    { placeholder: '123 West Walnut Street #1234', label: 'Practice Address (line1)', key: 'PracticeAddress' },
      ...
      <Col className='py-5'>
        {CreateAccount.map((input, index) => (
          ...
          >
            ...
            <input
              type={input.type || 'text'} // Use 'text' as default type
